...
public class PaymentDepartment implements CustomerCare {
    ...
    public void getService() {
        ...
        System.out.println("How may I assist with your payment inquiry?");
    }
    ...
    public void getProblem() {
        ...
        System.out.println("Dear "+customerName+", your issue for "+this.issue+" has been recorded with our "+this.department+", your reference id is: "+this.refId);
    }
}
